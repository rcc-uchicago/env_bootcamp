...
# Process: Buffer...
arcpy.Buffer_analysis(major_roads, road_buffer, "10000.000000 Meters", "FULL", "ROUND", "ALL", "")

# Process: Clip...
arcpy.Clip_analysis(tracts, road_buffer, clipped_tracts, "")
...
# Process: Add Field...
arcpy.AddField_management(clipped_tracts, "NEW_CLASS", "LONG", "", "", "", "", "NULLABLE", "NON_REQUIRED", "")
...
rows = arcpy.SearchCursor(clipped_tracts, '"NEW_CLASS" >= 5')
for row in rows:
    print row.fipsco
